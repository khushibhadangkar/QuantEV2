...
CITY_DISTRICT_NAMES: Dict[str, Dict[str, Dict[str, str]]] = {
    ...
    "Mumbai": {
        ...
        "Z2": {"primary": "Powai & Kanjurmarg Tech Valley", "secondary": "Central Suburbs IT Corridor"},
        "Z3": {"primary": "South Mumbai Financial Core", "secondary": "Nariman Point & Fort District"},
        "Z4": {"primary": "Andheri West & Lokhandwala", "secondary": "Western Media & Retail Hub"},
        "Z5": {"primary": "Lower Parel Corporate District", "secondary": "High Street Phoenix & Mills Hub"},
        "Z6": {"primary": "Ghatkopar & Kurla East Junction", "secondary": "Central Transit Interchange"},
        "Z7": {"primary": "Dadar & Worli Seaface Hub", "secondary": "Prabhadevi & Coastal Corridor"},
    },
    "San Francisco": {
